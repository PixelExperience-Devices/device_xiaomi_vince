...
# Bluetooth
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs//hidl/component-overrides.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sysconfig/component-overrides.xml
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/thermal-engine/thermal-engine.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine.conf
...
# Inherit proprietary files from vendor
